...
\begin{tikzpicture}[
	...
	\node (x0) [below of=empty01,yshift=1mm] {$\bm{x}(t_0)$};
	...
	\node (x1) [below of=empty11,yshift=1mm] {$\bm{x}(t_1)$};
	...
	\node (x2) [below of=empty21,yshift=1mm] {$\bm{x}(t_2)$};
	...
	\node (x3) [below of=empty31,yshift=1mm] {$\bm{x}(t_3)$};
