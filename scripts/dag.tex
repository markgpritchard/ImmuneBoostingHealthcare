...
\begin{tikzpicture}[
	...
	%% time 0
	\node (empty01) { };
	\node (ic0) [right of=empty01]  {$i_{\mathrm{c}}(t_0)$};		
	\node (ip0) [right of=ic0] {$i_{\mathrm{p}}(t_0)$};
	\node (ih0) [right of=ip0] {$i_{\mathrm{h}}(t_0)$};
	\node (empty05) [right of=ih0] { };
	\node (empty06) [right of=empty05] { };
	\node (x0) [below of=empty01,yshift=2mm] {$\mathbf{x}(t_0)$};
	\node (empty02) [right of=x0] { };
	\node (empty03) [right of=empty02] { };
	\node (empty04) [right of=empty03] { };
	\node (l0)[unobserved] [right of=empty04] {$\lambda(t_0)$};
	\node (r0)[unobserved] [right of=l0] {$r_{\mathrm{h}}(t_0)$};
	
	%% time 1
	\node (empty11) [below of=x0] { };
	\node (ic1) [right of=empty11]  {$i_{\mathrm{c}}(t_1)$};		
	\node (ip1) [right of=ic1] {$i_{\mathrm{p}}(t_1)$};
	\node (ih1) [right of=ip1] {$i_{\mathrm{h}}(t_1)$};
	\node (empty15) [right of=ih1] { };
	\node (empty16) [right of=empty15] { };
	\node (x1) [below of=empty11,yshift=2mm] {$\mathbf{x}(t_1)$};
	\node (empty12) [right of=x1] { };
	\node (empty13) [right of=empty12] { };
	\node (empty14) [right of=empty13] { };
	\node (l1)[unobserved] [right of=empty14] {$\lambda(t_1)$};
	\node (r1)[unobserved] [right of=l1] {$r_{\mathrm{h}}(t_1)$};

	%% time 2
	\node (empty21) [below of=x1] { };
	\node (ic2) [right of=empty21]  {$i_{\mathrm{c}}(t_2)$};		
	\node (ip2) [right of=ic2] {$i_{\mathrm{p}}(t_2)$};
	\node (ih2) [right of=ip2] {$i_{\mathrm{h}}(t_2)$};
	\node (empty25) [right of=ih2] { };
	\node (empty26) [right of=empty25] { };
	\node (x2) [below of=empty21,yshift=2mm] {$\mathbf{x}(t_2)$};
	\node (empty22) [right of=x2] { };
	\node (empty23) [right of=empty22] { };
	\node (empty24) [right of=empty23] { };
	\node (l2)[unobserved] [right of=empty24] {$\lambda(t_2)$};
	\node (r2)[unobserved] [right of=l2] {$r_{\mathrm{h}}(t_2)$};
	
	%% time 3
	\node (empty31) [below of=x2] { };
	\node (ic3) [right of=empty31]  {$i_{\mathrm{c}}(t_3)$};		
	\node (ip3) [right of=ic3] {$i_{\mathrm{p}}(t_3)$};
	\node (ih3) [right of=ip3] {$i_{\mathrm{h}}(t_3)$};
	\node (empty35) [right of=ih3] { };
	\node (empty36) [right of=empty35] { };
	\node (x3) [below of=empty31,yshift=2mm] {$\mathbf{x}(t_3)$};
	\node (empty32) [right of=x3] { };
	\node (empty33) [right of=empty32] { };
	\node (empty34) [right of=empty33] { };
	\node (l3)[unobserved] [right of=empty34] {$\lambda(t_3)$};
	\node (r3)[unobserved] [right of=l3] {$r_{\mathrm{h}}(t_3)$};
	
	%% time 4
	\node (empty41) [below of=x3] { };
	\node (ic4) [right of=empty41]  {$i_{\mathrm{c}}(t_4)$};		
	\node (ip4) [right of=ic4] {$i_{\mathrm{p}}(t_4)$};
	\node (ih4) [right of=ip4] {$i_{\mathrm{h}}(t_4)$};
