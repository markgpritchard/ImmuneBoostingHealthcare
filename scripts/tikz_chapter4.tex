...
\begin{tikzpicture}[>={Stealth[round]},thick,black!50,text=black,
	...
	\graph [grow down sep=8mm, branch right=7mm] {
		...
		s/"$s_j$" [supnoninfectious,xshift=38mm] {"$s_j$"}->[dashed,red!50!black!50,"$\lambda_{\mathrm{h}}$"']
		...
		ip/"$i_{\mathrm{p}j}$" [supinfectious,xshift=84mm,yshift=-35mm] {"$i_{\mathrm{p}j}$"};
	};
	...
	\draw [->,rounded corners,shorten <= -2.5pt] ($(i.west)$) -- ($ (i.west) + (-2.5mm,omm) $) to [edge label'=$\theta$,color=black!50] ($ (r1.south east) + (2.5mm,-2.5mm) $) -- ($ (r1.south east) $);
	...
	\draw [->,rounded corners,shorten >= 1pt,dashed,red!50!black!50,] ($(r2.east)$) to [edge node={node [sloped,below] {$\psi\,\lambda_{\mathrm{c}}$}}] ($ (r2.east) + (7.5mm,2.5mm) $) -- ($ (r1.330) + (7.5mm,-2.5mm) $) -- ($ (r1.330) $);
	...
	\draw [->,rounded corners,shorten >= 1pt,dashed,red!50!black!50,] ($(r3.25)$) -- ($ (r3.25) + (17.5mm,5mm) $) -- ($ (r1.east) + (17.5mm,-2.5mm) $) to [edge node={node [sloped,above] {$\psi\,\lambda_{\mathrm{c}}$}}] ($ (r1.east) $);
